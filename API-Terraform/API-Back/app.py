...
def criar_grupo_seguranca_Windows_az(terraform_dir):
    try:
...
def Criar_AZURE(resources_to_create):
    ...
    resource_functions = {
        ...
        'network_security_windows': criar_grupo_seguranca_Windows_az,
    ...
    menu_options = {
        ...
        "azure": {
            "create": [
                ...
                "subnet_publica",
                "subnet_privada",
                "network_security_linux",
                "network_security_windows",
                "public_ip_linux",
                "public_ip_windows",
